            ...
            <div class="row gy-4">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="acerca.html" class="text-white-50 text-decoration-none hover-white">Acerca de</a></li>
                        <li class="mb-2"><a href="planes.html" class="text-white-50 text-decoration-none hover-white">Planes</a></li>
                        <li class="mb-2"><a href="contacto.html" class="text-white-50 text-decoration-none hover-white">Contacto</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
